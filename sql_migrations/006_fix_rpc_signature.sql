-- FIX RPC SIGNATURE REGRESSION
-- Restoring missing parameters (direction, stop_loss, risk_amount) to submit_trade
-- while keeping performance fixes (Advisory Locks, Index check).
