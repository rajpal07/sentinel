    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
                ...
                <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] bg-secondary/20 rounded-full blur-[100px]" />
            </div>
                ...
                <Card className="border-border/50 bg-card/50 backdrop-blur-xl shadow-2xl">
                    ...
                    <CardContent>
                        <form onSubmit={handleLogin} className="space-y-4">
                            ...
                            <Button
                                type="button"
                                variant="outline"
                                className="w-full bg-background/50 border-input/50 hover:bg-accent hover:text-accent-foreground transition-all cursor-pointer"
                                onClick={async () => {
                    ...
                    <CardFooter className="justify-center">
                        <p className="text-sm text-muted-foreground">
                            First time? <Link href="/signup" className="text-primary hover:text-primary/80 hover:underline transition-colors">Initialize Protocol</Link>
                        </p>
                    </CardFooter>
                </Card>
            </motion.div>
